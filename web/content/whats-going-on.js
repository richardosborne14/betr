/*
  ...
  rather than a fear, and scope §5.3a calls that the closest thing here to the regulatory
  line. Three rules held while writing it:
    ...
    2. Nothing here claims to treat, fix, reduce or track anything. A door opens onto three or
       four fears from the same fixed list; that is all it does.
    3. Nothing here becomes a test. Tapping a surface problem shows fears, and every test still
       comes from fears.js, so no test can touch the thing named on this screen.

  RELEASE CONDITION: Misha signs off all six labels before this ships to anyone (B0 Q2a).
  Built, not cleared.

  Each item: id, label, under (one sentence naming the fears in plain words), fears (ids).
*/
var BETR_DOORS = {
  intro: 'Tap what’s closest. It just points you at the fears that usually sit under it.',
  foot: 'None of these gets tested. The fear underneath does.',
  items: [
    {
      id: 'drinking',
