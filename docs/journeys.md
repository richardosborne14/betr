...
| 2 | Tap **Pick a fear** | Twelve fears as big buttons, *Something else* last, and a line about what is deliberately absent |
...
| 9 | Type one sentence, tap **Next** | Your belief in quotes, four buttons. No slider anywhere |
| 10 | Tap **A lot less sure** | Your expectation with a line through it; what happened highlighted underneath; a big **1** |
| 11 | Tap **Do it again tomorrow** | The same test, ready to lock in again |
| 12 | Tap **back**, then **home**, then **Not sure which? Start from what's going on** | Six things a person might say about themselves, each with a line about the fears underneath |
| 13 | Tap **Drinking more than I mean to** | Four fears, not a test. Nothing here is a test of the drink |
...
| 20 | Tap **what this is** | Airplane-mode line; 0 accounts; 0 B sent; the nine sentences; the crisis lines with 988, 116 123 and findahelpline.com; the TrybeUP line; the build hash |
